...
// has subscribed to. This package comes has two built-in implementations:
// NoChannels and QueryStringChannels, but you can implement your own.
...
// A NoChannels implements the ChannelSubscriber interface by parsing the
// request querystring and extracting channels separated by commas. Eg.:
// /?channels=a,b,c
